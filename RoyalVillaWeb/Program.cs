...
//Auto mapper (Manual) need to installed
builder.Services.AddHttpContextAccessor();
builder.Services.AddDistributedMemoryCache();//Auto mapper (Manual)
...
app.UseRouting();
app.UseSession(); //Add Manual
app.UseAuthentication(); //Add Manual
